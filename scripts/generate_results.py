...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', type=str, help='loss function method, \'sigmoid\' or \'step\' ')
    ...
    if args.loss is not None:
        loss_fnc = args.loss
        p_run_nn_tests = partial(run_nn_tests_with_lossF, dir_quant=dir_quant, dir_target=dir_target, N_trials=N_trials,
